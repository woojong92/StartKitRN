...
import { SafeAreaView, StyleSheet, View, Text, Image, TouchableWithoutFeedback } from 'react-native';
import HomeHeader from '../../../components/Home/HomeHeader'
import Theme from '../../../theme';
import LinearGradient from 'react-native-linear-gradient'
import { useTheme } from '@react-navigation/native';
import { HomeSectionTitle, HomeSectionSubTitle } from '../../../components/Home/OutsideStoreLayout';
    ...
    <>
      <SafeAreaView style={styles.container}>
        ...
        <View style={{paddingHorizontal: 22, marginTop : 27}}>
          <Text style={{ fontSize: 24, fontWeight: 'bold'}}> 안녕하세요 비스키트님, </Text>   
          <Text 
            style={{
              fontSize: 24,
              width: 209,
          ...
          <View style={{flexDirection: 'row', marginTop: 12,}}>
            ...
            <Image source={require('../../../assets/Home/icn_wifi_color.png')} style={{width: 14, height: 14}} />
          </View>  
